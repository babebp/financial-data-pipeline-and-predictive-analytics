...
def collect_all(client: BinanceClient, exchange: str, symbol: str):
    """Main function for collecting and storing historical price into h5 database"""
    ...
    if oldest_ts is None:
        # Get historical price till the 1-minute before 
    ...
    while True:
        # Get historical price from latest data plus 1 minute
